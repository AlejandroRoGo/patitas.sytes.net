...
<div class="container mt-4 mb-5">
    ...
    <?php if (isset($_SESSION['pedido_exito']) && $_SESSION['pedido_exito']) { ?>
    <div class="alert alert-success alert-dismissible fade show mt-4" role="alert" style="font-size:1.2rem;">
        <strong>¡Compra realizada con éxito!</strong> Gracias por tu pedido. Puedes ver los detalles en la sección de pedidos.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Cerrar"></button>
    </div>
    <?php unset($_SESSION['pedido_exito']); } ?>
    <div class="row g-4">
        <!-- Datos personales -->
